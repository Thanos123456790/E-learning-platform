let data = [
    {
        ...
        'youtubeId': 'rjG5LwbqAp4?si=uy33mRssrOIrR82G',
    },
    {
        'id': '2.',
        'title': 'Deterministic Finite Automata (DFA) and Equivalence with Regular Expressions',
        'youtubeId': 'CiXJnosT0UE?si=NGwFviv2rBS5Xe7m',
    },
    {
        'id': '3.',
        'title': 'Non-Deterministic Finite Automata (NFA)',
        'youtubeId': 'Dli3czfNvlo?si=vy9i3nzUun-SKIXe',
    },
    {
        'id': '4.',
        'title': 'Regular Grammars and Equivalence with Finite Automata',
        'youtubeId': 'YkrznM6w_4o?si=xXxLy5hJPGGvPAfc',
    },
    {
        'id': '5.',
        'title': 'Properties of Regular Languages',
        'youtubeId': '2k8r4HGdxBw?si=hoWnFDu4MqMSFvLy',
    },
    {
        'id': '6.',
        'title': 'Pumping Lemma for Regular Languages',
        'youtubeId': 'WdmbZnUesRw?si=mrk_2BHNh0tpa2Tq',
    },
    {
        'id': '7.',
        'title': 'Minimization of Finite Automata',
        'youtubeId': 'A7eKj_GXam0?si=-jlJ-fmGWQ6SIE6E',
    },
];
