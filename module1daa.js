let data = [
    {
        'id': '1.',
        'title': 'Insertion',
        'youtubeId': 'bAQlB6G1w-o',
    },
    {
        'id': '2.',
        'title': 'Deletion',
        'youtubeId': 'RWqQjOWnES8',
    },
    {
        'id': '3.',
        'title': 'Traversal',
        'youtubeId': 'lUt_Hn4i82g',
    },
    {
        'id': '4.',
        'title': 'Asymptotic Notations',
        'youtubeId': '7dz8Iaf_weM',
    },
    {
        'id': '5.',
        'title': 'Time space trade off',
        'youtubeId': 'r58oVFCaJRw',
    },
    {
        'id': '6.',
        'title': 'Linear search',
        'youtubeId': 't9gErvSVid0',
    },
    {
        'id': '7.',
        'title': 'Binary search',
        'youtubeId': '9HlbVEVt_Y0',
    },
    // Add more video data with YouTube video IDs following the same format
];
