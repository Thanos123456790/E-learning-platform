let data = [
    {
        'id': '1.',
        'title': 'Taxonomy of Parallel Architecture',
        'youtubeId': 'qgbt9mrQ7Gs?si=KqVNw3X3b8qJ6Epy',
    },
    {
        'id': '2.',
        'title': 'Centralized Shared-Memory Architecture',
        'youtubeId': 's_6KWykVw9I?si=-xWgfCHJsnj-6CuJ',
    },
    {
        'id': '3.',
        'title': 'Synchronization Memory Consistency',
        'youtubeId': 'hhCzanCll-c?si=g94rPNEARG4qLSxg',
    },
    {
        'id': '4.',
        'title': 'Interconnection Networks',
        'youtubeId': 'kI546SzGbLM?si=rnvA6m-qAZPzqwcZ',
    },
    {
        'id': '5.',
        'title': 'Distributed Shared-Memory Architecture',
        'youtubeId': '_wVt9bCis_I?si=Sadci3VIvHcMAHGQ',
    },
    {
        'id': '6.',
        'title': 'Cluster Computers',
        'youtubeId': 'Kd4a7UoqBC8?si=1mSl4-lnY8hs9tj-',
    },
];
