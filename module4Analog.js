let data = [
    {
        'id': 'AD and DA conversion Tecnique',
        'title': 'AD and DA conversion Tecnique',
        'youtubeId': 'Uc2R7GND0Dk?si=sCYj3RQEZ5gzuKcX',
    },
    {
        'id': 'Logic Family',
        'title': 'Logic Family',
        'youtubeId': 'qXelKoWSj_c?si=Y4cZt4povInhDEid',
    },
    {
        'id': 'TTL',
        'title': 'TTL',
        'youtubeId': '6Zd582d-PfU?si=yMgZkfJ5GKxEMEOc',
    },
    {
        'id': 'ECL',
        'title': 'ECL',
        'youtubeId': 'w5XX4zus_ro?si=EQLQeCoBmi2_uyoc',
    },
    {
        'id': 'MOS',
        'title': 'MOS',
        'youtubeId': 'Lji5vHbRLlk?si=41K4fUf3YCwIegGa',
    },
    {
        'id': 'CMOS',
        'title': 'CMOS',
        'youtubeId': 'ZkrAn5vNmig?si=8uUXyu5HENHGsmJe',
    },
