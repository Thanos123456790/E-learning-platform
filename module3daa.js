let data = [
    ...
    },
    {
        'id': '2.',
        'title': 'Traversing',
        'youtubeId': 'e0s-zmpedYo?si=-4YdC4xxp_lcs9K8',
    },
    {
        'id': '3.',
        'title': 'Searching',
        'youtubeId': 'DmSxG4AaeeU?si=BiE66X1W-_y-m844',
    },
    {
        'id': '4.',
        'title': 'Deletion',
        'youtubeId': 'ClvYytk5Rlg?si=S_lknd_WSHWJeBg5',
    },
    {
        'id': '5.',
        'title': 'Linked representation of stack',
        'youtubeId': 'T_UXDTy23DQ?si=uZe7NgB-1wKmTDCP',
    },
    {
        'id': '6.',
        'title': 'Linked representation of Queue',
        'youtubeId': 'RN1wzY_tnYU?si=pyex43Mb2tQ1O5q3',
    },
    {
        'id': '7.',
        'title': 'Header nodes',
        'youtubeId': 'hNW3Cyq_044?si=oWDMOPTFAsLSCpWF',
    },
    {
        'id': '8.',
        'title': 'Doubly linked list',
        'youtubeId': 'e9NG_a6Z0mg?si=7mY1cwKdrYgnNeUw',
    },
    {
        'id': '9.',
        'title': 'Circular linked list',
        'youtubeId': 'HMkdlu5sP4A?si=ECrY_BozyzLafPgt',
    },
