let data = [
    {
        'id': '1.',
        'title': 'Memory unit design with special emphasis on CPU memory interfacing',
        'youtubeId': '9ZSw0AAIp_g',
    },
    {
        'id': '2.',
        'title': 'Memory organization',
        'youtubeId': 'zwovvWfkuSg',
    },
    {
        'id': '3.',
        'title': 'Static memory',
        'youtubeId': 'u7RPY98y3rg',
    },
    {
        'id': '4.',
        'title': 'Dynamic memory',
        'youtubeId': 'udfbq4M2Kfc',
    },
    {
        'id': '5.',
        'title': 'Associative memory',
        'youtubeId': 'Dla3YG59bKo',
    },
    {
        'id': '6.',
        'title': 'Cache memory',
        'youtubeId': 'joWVGwnEiYw',
    },
    {
        'id': '7.',
        'title': 'Virtual memory',
        'youtubeId': 'wuakWE44_ZA',
    },
